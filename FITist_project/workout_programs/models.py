...
class ProgramTag(models.Model):
    """Each program has multiple tags that separate it from other programs."""

    label = models.CharField(max_length=50)

    def __str__(self):
        """Will return the label as the query set description."""
        return self.label
...
class Program(models.Model):
    ...
    tags = models.ManyToManyField(ProgramTag)
...
#
#     def __str__(self):
#         """Will set number & ExerciseBlock name as query set description."""
